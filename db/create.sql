CREATE DATABASE IF NOT EXISTS seito_db;

CREATE USER IF NOT EXISTS 'skawano'@'localhost' IDENTIFIED BY 'Passw0rd';
GRANT ALL PRIVILEGES ON seito_db.* TO 'skawano'@'localhost';
FLUSH PRIVILEGES;
